...
AntAspectWhenLaden = (180, -3, 'shape=ant_stencil_red.gif')	# -3 = size in logical coordinates
...
class FoodSource:
	...
	def __init__(self, Name):
		...
		self.Distribution = Gbl.Parameter('FoodQuantity') // ((2*self.Radius) ** 2)
		self.Area = []
...
if __name__ == "__main__":
	...
	if Gbl.Parameter('RandomSeed') > 0:	random.seed(Gbl.Parameter('RandomSeed'))
